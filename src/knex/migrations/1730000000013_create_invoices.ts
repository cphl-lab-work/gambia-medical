...
export async function up(knex: Knex): Promise<void> {
  ...
  `);
  await knex.raw(`CREATE INDEX IF NOT EXISTS "IDX_invoices_patient_id" ON "invoices" ("patient_id")`);
...
export async function down(knex: Knex): Promise<void> {
  await knex.raw(`DROP INDEX IF EXISTS "IDX_invoice_items_invoice_id"`);
  await knex.raw(`DROP TABLE IF EXISTS "invoice_items"`);
  await knex.raw(`DROP INDEX IF EXISTS "IDX_invoices_status"`);
  await knex.raw(`DROP INDEX IF EXISTS "IDX_invoices_patient_id"`);
